...
The goal of GitAI is to derive knowledge about given GitHub and GitLab repositories with the use of Large Language Models. Written in tidyverse style it allows user to easily setup scope (repositories), content of interest (files), LLMs with a prompt and process it.
