...
not knowing the exact keywords that should be use.
...
At the same time, is IT infrastructure agnostic. It is design to work with
...
1. Use the information extracted from files content from git repositories.
  ...
  they can be search using *semantic search* or used as a part of a RAG (*Retrieval Augmented Generation*) prompt.
